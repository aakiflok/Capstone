...
type TabName = 'home' | 'products' | 'invoice' | 'inventory' | 'customers'| 'employees' | 'reports' | 'logout' | 'profile';
    ...
    <div style={navStyle}>
      <nav style={ulStyle} className="nav">
        <ul style={ulStyle}>
          ...
          <li style={liStyle} onClick={() => setActiveTab('employees')}>
            Employees
          </li>
          <li style={liStyle} onClick={() => setActiveTab('reports')}>
            Reports
          </li>
          <li style={liStyle} onClick={() => setActiveTab('profile')}>
            Profile
          </li>
          <li style={liStyle} onClick={() => setActiveTab('logout')}>
            Logout
          </li>
        </ul>
      </nav>
